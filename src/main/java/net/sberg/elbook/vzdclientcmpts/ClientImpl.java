...
import de.gematik.vzd.ApiClient;
import de.gematik.vzd.auth.HttpBasicAuth;
import de.gematik.vzd.auth.OAuth;
...
public class ClientImpl extends ApiClient {
    ...
    public ClientImpl(final TiVZDProperties tiVZDProperties, final Map<String, String> parameters, String id) throws Exception {
        super();
