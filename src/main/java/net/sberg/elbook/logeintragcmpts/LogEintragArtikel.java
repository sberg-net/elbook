...
@DaoDescriptorClass
@Component
public class LogEintragArtikel {

    @DaoDescriptorElement(notNull = true)
    private int id;

    @DaoDescriptorElement(notNull = true)
    private int logEintragId;

    @DaoDescriptorElement(notNull = true)
    private String vzdUid;

    @DaoDescriptorElement
    private String vzdZertUid;

    @DaoDescriptorElement(notNull = true)
    private EnumLogEintragArtikelTyp typ = EnumLogEintragArtikelTyp.MANUAL_INSERT;
