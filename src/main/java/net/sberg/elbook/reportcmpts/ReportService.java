...
public class ReportService {
    ...
    private ReportDescriptorKey start(
        ...
        try {
            ...
            DefaultCommandResultCallbackHandler commandResultCallbackHandler = verzeichnisdienstService.uebersicht(tiVZDProperties, readDirSyncEntryCommand);

            List<DirectoryEntry> entries = commandResultCallbackHandler.getDirectoryEntries(readDirSyncEntryCommand.getId());
